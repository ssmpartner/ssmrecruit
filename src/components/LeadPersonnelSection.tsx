...
import {
  ChevronDown, ChevronRight, Save, UserSquare2, Loader2, Link2, Copy, Check, Clock, History,
} from 'lucide-react';
            ...
            <>
              ...
              <div className="flex flex-wrap items-center gap-2 rounded-md border bg-background p-2">
                ...
                >
                  ...
                  Link für Kandidat generieren (14 Tage)
                </button>
                {versions.length > 0 && (
                  <button
                    type="button"
