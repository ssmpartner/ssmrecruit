...
type SettingsTab = 'notifications' | 'users' | 'appointments' | 'insights' | 'integrations' | 'api' | 'api-docs' | 'documentation';
...
const tabs: { id: SettingsTab; label: string; icon: typeof Bell; desc: string }[] = [
  ...
  { id: 'documentation', label: 'Dokumentation', icon: FileText, desc: 'Versionen, Updates & Funktionen' },
];
...
const versionHistory = [
  { version: '2.4.0', date: '18.03.2026', changes: ['API-Modul mit Schlüsselverwaltung & Dokumentation', 'Dokumentationsbereich in Einstellungen hinzugefügt', 'Erweiterte Berechtigungsscopes für API-Keys'] },
...
function DocumentationTab() {
  ...
  return (
    <>
      <div>
        <h2 className="text-lg font-semibold flex items-center gap-2"><FileText className="h-5 w-5" /> Dokumentation</h2>
        <p className="text-sm text-muted-foreground">Versionierung, Updates und Funktionsübersicht von RecruitFlow</p>
      </div>
